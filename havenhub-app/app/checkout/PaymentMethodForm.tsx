...
const PaymentMethod = () => {
  ...
  return <div className="bg-gray-50 px-4 pt-6">
    ...
    <div className="">
      ...
      <div className="flex flex-col sm:flex-row">
        <div className="relative flex-shrink-0 sm:w-7/12">
          <input type="text" id="billing-address" name="billing-address" className="w-full rounded-md border border-gray-200 px-4 py-3 pl-8 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="Street Address" />
      ...
      <div className="mt-6 border-t border-b py-2">
        <div className="flex items-center justify-between">
          <p className="text-sm font-medium text-gray-900">Per night</p>
          <p className="font-semibold text-gray-900">299.00 ETB</p>
        </div>
        <div className="flex items-center justify-between">
          <p className="text-sm font-medium text-gray-900">Total nights</p>
          <p className="font-semibold text-gray-900">x3</p>
        </div>
      </div>
      <div className="mt-6 flex items-center justify-between">
        <p className="text-sm font-medium text-gray-900">Total</p>
        <p className="text-2xl font-semibold text-gray-900">899.00 ETB</p>
      </div>
    </div>
    <button onClick={() => {router.push("/agreement")}} className="mt-4 mb-8 w-full rounded-md company-bg-color px-6 py-3 font-medium text-white">Place Order</button>
  </div>
}
