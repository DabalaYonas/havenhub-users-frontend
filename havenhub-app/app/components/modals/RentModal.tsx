...
const RentModal = () => {
  ...
  if (steps === STEPS.LOCATION) {
    bodyContent = (
      ...
      <div className="flex flex-col gap-8">
        <Heading
          title="Where do you place located?"
          subtitle="Help guests find you!"
        />
        <CountrySelect
          value={location}
  ...
  if (steps === STEPS.IMAGES) {
    bodyContent = (
      <div className="flex flex-col gap-2">
        ...
        />
        <div className="flex self-end gap-2 rounded-full border px-4 py-2 cursor-pointer hover:shadow"><BiPlus size={24} /> Add more</div>
        <UploadView setImageInput={setImageInput} />
      </div>
    );
  }
  ...
  return (
    <Modal
      ...
      title="Host your home on HavenHub"
      body={bodyContent}
    />
  );
};
